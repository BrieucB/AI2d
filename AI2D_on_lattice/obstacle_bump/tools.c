...
/* Dynamics update */
void updatePositionsObstacle(int lx, int ly, int *x, int *y, int *s, int N, int **local_m, int **local_rho, double w0, double beta, double v, double D, double dt, pcg32_random_t *rng, int xo, int yo, double ro)
{
...
/* Dynamics update */
void updatePositionsObstacleBump(int lx, int ly, int *x, int *y, int *s, int N, int **local_m, int **local_rho, double w0, double beta, double v, double D, double dt, pcg32_random_t *rng, int xo, int yo, double ro)
{
