...
mkdir fluct_size_ds_beta3
cd fluct_size_ds_beta3
...
do
    ...
    cat <<EOF > f_input.dat
ncpu = $ncpu nby_box = 4 tgap = 2000 tmax = 2100 dt = 0.01 lx = 2000 ly = 1000 ds = $ds rhol = 1 beta = 3 v = 1 D = 1 gamma = 1 rhof = 10
EOF
