...
mkdir droplet_size_beta_D2
cd droplet_size_beta_D2

ncpu=32

cp ../f_soumis.sh .

for beta in 1.1 1.3 1.5 1.7 1.9 2.1 2.3 2.5 2.6 2.8 3.0
...
do
    ...
    cat <<EOF > f_input.dat
tgap = 5000 tmax = 5100 dt = 0.05 lx = 5500 ly = 2200 ds = 1 rhol = 1 beta = $beta v = 1 D = 2 gamma = 1 rhof = 10
EOF
