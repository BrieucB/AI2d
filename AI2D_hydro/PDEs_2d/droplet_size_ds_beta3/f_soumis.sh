...
mkdir droplet_size_ds_beta3
cd droplet_size_ds_beta3
...
do
    ...
    cat <<EOF > f_input.dat
tgap = 2000 tmax = 2100 dt = 0.01 lx = 1500 ly = 600 ds = $ds rhol = 1 beta = 3 v = 1 D = 0.5 gamma = 1 rhof = 10
EOF

    cat <<EOF > f_simu.sh
#!/usr/bin/bash
#SBATCH --job-name=pde$ds
#SBATCH -t 6-00:00:00
#SBATCH --partition=multix,multix96,multix64
#SBATCH --nodes=1
#SBATCH --ntasks=1
